...
try {
    ...
    // Property xml
    $propertiesData = generatePropertiesXML($leadPostData, $accountGUID, $contactGUID);
    echo $propertiesData;
    ...
    if (empty($propertiesGUID)) {
            echo "ERROR:  Properties Creation Failed\n\n";
            echo $propertiesResponse;
            exit;
    }

    // Opportunity XML below
    $opportunityData = generateOpportunityXml($leadPostData, $accountGUID, $contactGUID, $propertiesGUID);
    echo $opportunityData;
    ...
    echo "opportunity id: " . $opportunityGUID;
    if (empty($opportunityGUID)) {
            echo "ERROR: Opportunity Creation Failed\n\n";
            echo $opportunityResponse;
            exit;
    }
        ...
        <entry xmlns="http://www.w3.org/2005/Atom" xmlns:d="http://schemas.microsoft.com/ado/2007/08/dataservices" xmlns:m="http://schemas.microsoft.com/ado/2007/08/dataservices/metadata">
            ...
            <content type="application/xml">
                <m:properties>
                    ...
                    <d:Phone>'.$lead['homephone'].'</d:Phone>
...
function generateContactXml($lead = array(), $accountId) {
    ...
    if (empty($lead['yearsatresidence'])) {
        $lead['yearsatresidence'] = rand(1,5);
    }
    ...
    switch (strtolower($lead['driver1maritalstatus'])) {
        case 'divorced':
                $lead['driver1maritalstatus'] = 'e4e3e3b4-58a8-4fc2-993b-1a1447771a30';
                break;
        case 'married':
                $lead['driver1maritalstatus'] = '76ac1d57-1391-4686-a32d-d6bf7e394e5d';
                break;
        case 'separated':
                $lead['driver1maritalstatus'] = 'ef2ff4bf-0d45-47da-9742-cb4aaee5edaa';
                break;
        case 'single':
                $lead['driver1maritalstatus'] = 'f4159108-4fdd-4843-91bb-1e20a0e807ff';
                break;
        case 'widowed':
                $lead['driver1maritalstatus'] = '07f0c96a-d837-4809-8bbb-641c57ed1dca';
                break;
        default: // unknown
         $lead['driver1maritalstatus'] = 'a43101d2-8878-4102-96a8-03747f427936';
    }

        switch (strtolower($lead['driver1edulevel'])) {
            case 'AA':
                $lead['driver1edulevel'] = 'f9224bec-dc80-4e75-ae8b-97da3a01ee72';
                break;
        case 'BA':
                $lead['driver1edulevel'] = 'f32e5638-2543-4c60-a4ed-e3a9a9943f60';
                break;
        case 'POST':
                $lead['driver1edulevel'] = 'e0d1b1af-1cd1-4a63-9e43-9794aae63c14';
                break;
        case 'HIGHSCHOOL':
                $lead['driver1edulevel'] = '1ae297ba-67fd-4d07-9edc-097fc53eeb9b';
                break;
        default:
                $lead['driver1edulevel'] = 'b38cc5ff-04c7-47af-98c9-363e6101bd8b';
    }
        ...
        <entry xmlns="http://www.w3.org/2005/Atom" xmlns:d="http://schemas.microsoft.com/ado/2007/08/dataservices" xmlns:m="http://schemas.microsoft.com/ado/2007/08/dataservices/metadata">
            ...
            <content type="application/xml">
                <m:properties>
                    ...
                    <d:BirthDate>'.$lead['driver1dob_year'].'-'.$lead['driver1dob_month'].'-'.$lead['driver1dob_day'].'</d:BirthDate>
                    ...
                    <d:DriverYearsAtRes>'.$lead['yearsatresidence'].'</d:DriverYearsAtRes>
...
function generatePropertiesXML($lead = array(), $accountId, $contactId) {
    ...
    $primaryUseMap = array(
            ...
            ''              => '7f82b1b4-6661-4201-b779-aabe9c61da57'
            );
    ...
    $leaseAndOwnership = leaseAndOwnership($lead['vehicle1leased']);
    
    if(isset($lead['vehicle2year']) && !empty($lead['vehicle2year']))
    {
    	$secondVehicle = '<d:VehYearColumn2>'.$lead['vehicle2year'].'</d:VehYearColumn2>
					      <d:VehMakeLookup2Id m:type="Edm.Guid">'.findConnectVehicleMake($lead['vehicle2make']).'</d:VehMakeLookup2Id>
					      <d:VehModelColumn2>'.$lead['vehicle2model'].'</d:VehModelColumn2>
					      <d:VehTrimColumn2>'.$lead['vehicle2trim'].'</d:VehTrimColumn2>
					      <d:LeasedBoolean2>'.$leaseAndOwnership['lease'].'</d:LeasedBoolean2>
					      <d:OwnershipLookup2Id m:type="Edm.Guid">'.$leaseAndOwnership['ownership'].'</d:OwnershipLookup2Id>
					      <d:PrimaryUseLookup2Id m:type="Edm.Guid">'.$primaryUseMap[$lead['vehicle2primaryUse']].'</d:PrimaryUseLookup2Id>
        ...
        <entry xmlns="http://www.w3.org/2005/Atom" xmlns:d="http://schemas.microsoft.com/ado/2007/08/dataservices" xmlns:m="http://schemas.microsoft.com/ado/2007/08/dataservices/metadata">
            ...
            <content type="application/xml">
                <m:properties>
                    ...
                    <d:LeasedBoolean1>'.$leaseAndOwnership['leased'].'</d:LeasedBoolean1>
                    <d:OwnershipLookup1Id m:type="Edm.Guid">'.$leaseAndOwnership['ownership'].'</d:OwnershipLookup1Id>
...
function generateOpportunityXml($lead = array(), $accountId, $contactId, $propertyId) {
    ...
    switch ($lead['desiredcoveragetype']) {
        case 'SUPERIOR':
            $coverageTypeValue = 'ab460f64-5f3a-4590-a701-9784c1b71fce';
            $bodilyInjury = 'd3c0acb1-b88b-4b7b-9abd-889c8f3d0755';
            $bodilyInjuryPerIncident = '0b21c048-465c-40a1-8c9f-6088b07f3a4c';
            $propertyDamage = '2c9e834a-222a-4ddd-85f4-b56f5173ed70';
            break;
        case 'STANDARD':
            $coverageTypeValue = '1479f62f-890e-493e-9bf8-6bde38d23d67';
            $bodilyInjury = 'd248e18f-0eed-4bc5-a35c-3af536bad0b8';
            $bodilyInjuryPerIncident = '48ea207a-5452-4451-940c-4656b21c7bce';
            $propertyDamage = '07b23e09-eaa1-4b70-971b-c12666122158';
            break;
        case 'BASIC':
            $coverageTypeValue = '5f9d176b-24ce-4006-9e7f-cf521a0f17b9';
            ...
            break;
        default: // State Minimum
            $coverageTypeValue = 'ca6c3c2d-1322-4674-9c2e-753005271bda';
            $bodilyInjury = '4f1b0978-04d4-4355-a3b5-074f01f2fc30';
            $bodilyInjuryPerIncident = '03faf26d-4391-4e1d-87eb-c8f60e5a7a76';
            $propertyDamage = '5bf2a35a-b07e-4348-8247-54400ceecaaf';
    }

    if (empty($lead['currentpolicyexpiration'])) {
        $lead['currentpolicyexpiration'] = date('Y-m-01');
    }
        ...
        <entry xmlns="http://www.w3.org/2005/Atom" xmlns:d="http://schemas.microsoft.com/ado/2007/08/dataservices" xmlns:m="http://schemas.microsoft.com/ado/2007/08/dataservices/metadata">
            ...
            <content type="application/xml">
                <m:properties>
                    ...
                    <d:InsuredPropertyId m:type="Edm.Guid">'.$propertyId.'</d:InsuredPropertyId>
...
function findConnectVehicleMake($vehicleMake) {
	...
	switch(strtoupper($vehicleMake)) {
		case 'ACURA':
			$vehicleMake = '9188a5e0-a920-49b7-9a4e-c672a8f90dc3';
			break;
		case 'ASTON MARTIN':
			$vehicleMake = '13889d2f-3091-4808-bc52-a3b655652609';
			break;
		case 'AUDI':
			$vehicleMake = '9c6e88e0-8a6c-41ba-84be-d754e29cc92b';
			break;
		case 'AZURE DYNAMICS':
			$vehicleMake = '293bbcf4-af28-41d1-8766-872dededcaad';
			break;
		case 'BMW':
			$vehicleMake = '066f97d2-f615-4c14-a3a6-295959059b9d';
			break;
		case 'BUICK':
			$vehicleMake = 'b6ff2363-2510-4e5c-b963-00084cee286e';
			break;
		case 'CADILLAC':
			$vehicleMake = '5f055f76-38df-4128-9193-c5b9c4c0a1b4';
			break;
		case 'CHEVROLET':
			$vehicleMake = '4580ba0f-8425-49a3-8ef8-ac117de1b059';
			break;
		case 'CHRYSLER':
			$vehicleMake = '2fb530f2-b84e-4109-8361-5f76cbe1e3b3';
			break;
		case 'DODGE':
			$vehicleMake = '49baf27e-12d4-442b-911a-03927c16d378';
			break;
		case 'FERRARI':
			$vehicleMake = 'ad2909e4-3946-4628-af7a-ebbcad5f0769';
			break;
		case 'FIAT':
			$vehicleMake = '3f0f9ca0-d2dd-495f-bfa4-e2048eaf01f7';
			break;
		case 'FORD':
			$vehicleMake = 'a2cbd3e4-fa05-4e2a-a38c-7fc8fe1fbd78';
			break;
		case 'GMC':
			$vehicleMake = 'ac23264c-a747-4166-b795-8df287667f94';
			break;
		case 'HONDA':
			$vehicleMake = '7454989b-39e1-46e9-afbd-d9d5074d9ea2';
			break;
		case 'HYUNDAI':
			$vehicleMake = 'c388ed57-ae55-4c6a-89e3-057f2fb899f9';
			break;
		case 'INFINITI':
			$vehicleMake = '8bc09c5c-fbf8-4b64-b1ba-0d02c297b988';
			break;
		case 'JAGUAR':
			$vehicleMake = '1f4098d1-fb05-44fe-bccd-bd308eeeca1c';
			break;
		case 'JEEP':
			$vehicleMake = 'b4451646-1be5-499f-86f9-901a86e54ede';
			break;
		case 'KIA':
			$vehicleMake = '9b955728-16dc-42ed-a147-ed163a7634ea';
			break;
		case 'LAND ROVER':
			$vehicleMake = 'cb76e8c8-bba2-48b0-895a-04c25cef5dce';
			break;
		case 'LEXUS':
			$vehicleMake = '8bc2fd6c-50e6-43eb-ad04-f8e253e154f5';
			break;
		case 'LINCOLN':
			$vehicleMake = 'd45b8df2-1a09-406b-9e0f-e5feca33e4f0';
			break;
		case 'LOTUS':
			$vehicleMake = 'a191c656-02bf-49ab-bda7-900789920bae';
			break;
		case 'MASERATI':
			$vehicleMake = '38819946-5876-44e9-9152-5882ddb0ad24';
			break;
		case 'MAZDA':
			$vehicleMake = '10f7a97d-1de5-40b5-8bbf-f4018f316301';
			break;
		case 'MCLAREN':
			$vehicleMake = 'e05cf4ae-a171-4bb2-9c07-5a8823b758c7';
			break;
		case 'MERCEDES-BENZ':
			$vehicleMake = '38a4d018-e398-4c41-a8a6-b7e0ae93b728';
			break;
		case 'MERCEDEZ BENZ':
			$vehicleMake = '0d2c87ec-97a0-4278-830e-e0037b306781';
			break;
		case 'MERCURY':
			$vehicleMake = '2a1ef2db-f2f3-4f6e-a54f-4e4976917269';
			break;
		case 'MINI':
			$vehicleMake = 'bf834c18-af25-409e-8123-257eb03b435e';
			break;
		case 'MITSUBISHI':
			$vehicleMake = '6d7f4fc8-479c-4879-84a1-8b82c17211d5';
			break;
		case 'NISSAN':
			$vehicleMake = '63db129e-b0b6-42ea-b430-6e43311c8689';
			break;
		case 'OLDSMOBILE':
			$vehicleMake = '7639c283-5241-4562-93f4-c3813984c6ef';
			break;
		case 'PLYMOUTH':
			$vehicleMake = 'd29f59b9-71bf-4306-8848-9a096165e2e0';
			break;
		case 'PONTIAC':
			$vehicleMake = 'e2289380-4afb-4794-9e0a-510179bdc21f';
			break;
		case 'PORSCHE':
			$vehicleMake = '4f839a11-8823-4494-a791-623fdcf96fd4';
			break;
		case 'RAM':
			$vehicleMake = 'b2574d9f-c2ac-44fa-864a-5b38879d4bb7';
			break;
		case 'SAAB':
			$vehicleMake = '7f6ac617-af26-4e20-ae17-43f8accef257';
			break;
		case 'SATURN':
			$vehicleMake = '31e7e352-e638-4ce8-8dfd-fbf5cfb76700';
			break;
		case 'SMART':
			$vehicleMake = '5d6f384c-7bb1-4850-baca-4d1633d8e684';
			break;
		case 'SUBARU':
			$vehicleMake = 'd6e0347b-a077-4db5-9103-cc125958b02e';
			break;
		case 'SUZUKI':
			$vehicleMake = 'ff9abf46-b99c-4348-b9e3-3c12efa99ab7';
			break;
		case 'TESLA':
			$vehicleMake = '3d3520e7-e46c-49e7-9537-b1e187f9df81';
			break;
		case 'TOYOTA':
			$vehicleMake = 'd6c5582e-6198-4f10-839d-088f394fed1b';
			break;
		case 'VOLKSWAGEN':
			$vehicleMake = '1835d04e-0849-4a2e-a4fe-26b177d38632';
			break;
		default: // 'VOLVO'
			$vehicleMake = '352adab7-2644-4737-a41b-001cbf855dbf';
			break;
	}
...
function leaseAndOwnership( $ownership )
{
	switch ($ownership) {
		case 'Leased':
			$vehicleOwnership = 'd5f571ef-5bcc-416b-b97a-379bc45a7aff';
			$vehicleLease = 1;
			break;
		case 'Owned':
			$vehicleOwnership = '2d6ea226-93d8-4380-8c24-679da4d66862';
			$vehicleLease = 0;
			break;
		default:
			$vehicleOwnership = '8ededa22-2a32-417a-b3ee-35ec3855a518';
			$vehicleLease = 0; // I really think that this line here is not required
	}
	
	return array('ownership' => $vehicleOwnership, 'leased' => $vehicleLease);
}
