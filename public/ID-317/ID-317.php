<?php
	...
	$lmsData =  '{"universal_leadid":"GHCF0E79-RT2E-F3HJ-C760-C5A77AC7DEDF",
				  ...
				  "firstname":"Rebeca",
				  "lastname":"Pasillas",
				  "emailaddress":"beckypasillav@yahoo.com",
	...
	$testUrl = 'http://test1.leadamplms.com/prospect/prospect/ping';
	$productionUrl = 'https://prod1.leadamplms.com/prospect/ping';
	$params = array('vendorUniqueID' => 12345,
					'clientCode' => 'AMFAM',
					'sourceCode' => 'UGRELNT',
					'campaignCode' => 'AUTO',
					//'prepingID'  => '8102281',	// hardcoded for now
					'productCode'=> 'A',
	...
	echo "PING Response: --- "; var_dump($response);
	echo "<br>";
	...
	$response = getCurlRequest($testUrl, $params);
	echo "POST Response --- "; var_dump($response);